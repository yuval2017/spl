...
public abstract class MicroService implements Runnable { 
    ...
    private HashMap<Class<? extends Message>,Callback<? extends Message>> messagesActions;
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
    	...
    	messagesActions.put(type,callback);
    }
    ...
    protected abstract void setTerminateInDiary();
    /**
    ...
    public final void run() {
    	...
    	while(!terminate){
    	    try{
                ...
                Callback c = messagesActions.get(message.getClass());
    	        c.call(message);
            }
